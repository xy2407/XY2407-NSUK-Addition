...
public final class ColonyCoreScreenOpener {
    ...
    private static UIElement relocateRow(ColonyCoreOpenResponsePacket packet,
        ...
        info.addChild(line(Component.literal(
                citizen.citizenName() == null || citizen.citizenName().isBlank() ? "-" : citizen.citizenName())));
        Component jobComponent = Component.translatable(citizen.jobKey());
        Component workComponent = Component.translatable(citizen.workStatusKey());
        Component sourceComponent = Component.literal(citizen.sourceTerritory() == null ? "" : citizen.sourceTerritory());
