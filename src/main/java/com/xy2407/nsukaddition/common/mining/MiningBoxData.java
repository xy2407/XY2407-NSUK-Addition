...
public final class MiningBoxData {
    ...
    public boolean autoRestock() { return autoRestock; }
    public void setAutoRestock(boolean autoRestock) { this.autoRestock = autoRestock; }
    ...
    public CompoundTag toTag() {
        ...
        tag.putBoolean("AutoRestock", autoRestock);
    ...
    public static MiningBoxData fromTag(CompoundTag tag) {
        ...
        data.autoRestock = tag.getBoolean("AutoRestock");
