...
public final class ModBlocks {
    ...
    public static final DeferredBlock<Block> RESTAURANT_CONTROL_BOX = BLOCKS.register(
            "restaurant_control_box", RestaurantControlBoxBlock::new);
    ...
    public static final DeferredBlock<Block> FOREIGN_TRADE_CONTROL_BOX = BLOCKS.register(
            "foreign_trade_control_box", ForeignTradeControlBoxBlock::new);
    public static final DeferredItem<BlockItem> FOREIGN_TRADE_CONTROL_BOX_ITEM = ITEMS.register(
            "foreign_trade_control_box", () -> new BlockItem(FOREIGN_TRADE_CONTROL_BOX.get(), new Item.Properties()));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ForeignTradeControlBoxBlockEntity>> FOREIGN_TRADE_CONTROL_BOX_ENTITY =
