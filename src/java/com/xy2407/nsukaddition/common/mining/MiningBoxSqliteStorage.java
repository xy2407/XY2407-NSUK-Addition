            ...
            try {
                ...
                try (Connection connection = db.openConnection();
                     PreparedStatement ps = connection.prepareStatement(
                             "INSERT INTO mining_boxes(box_pos_long, current_y_level, work_ticks, running, auto_restock, status_key, status_text, updated_at) "
                                     + "VALUES(?, ?, ?, ?, ?, ?, ?, ?) "
                    ...
                    ps.setInt(5, data.autoRestock() ? 1 : 0);
        ...
        try {
            ...
            try (Connection connection = db.openConnection();
                ...
                while (rs.next()) {
                    ...
                    try { box.putBoolean("AutoRestock", rs.getInt("auto_restock") != 0); }
                    catch (SQLException ignored) { box.putBoolean("AutoRestock", false); }
